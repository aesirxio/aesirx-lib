...
class GroupItemModel extends BaseItemModel {
  ...
  static __transformItemToApiOfCreation = (data: any) => {
    return {
      ...
      [GROUP_API_RESPONSE_FIELD_KEY.PERCENT_COMPLETE]:
        data[GROUP_FIELD_KEY.PERCENT_COMPLETE ?? ''],
      [GROUP_API_RESPONSE_FIELD_KEY.NO_TO_DO_POSTS]:
        data[GROUP_FIELD_KEY.NO_TO_DO_POSTS ?? ''],
