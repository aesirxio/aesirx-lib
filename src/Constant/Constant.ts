...
const AXIOS_CONFIGS: any = {
  CLIENT_ID: env.REACT_APP_SSO_CLIENT_ID || env.REACT_APP_CLIENT_ID  || process?.env?.NEXT_PUBLIC_SSO_CLIENT_ID || '',
  CLIENT_SECRET: env.REACT_APP_SSO_CLIENT_SECRET || env.REACT_APP_CLIENT_SECRET || process?.env?.NEXT_PUBLIC_SSO_CLIENT_SECRET || '',
  BASE_ENDPOINT_URL: env.REACT_APP_ENDPOINT_URL || process?.env?.NEXT_PUBLIC_ENDPOINT_URL || 'https://apisss.aesirx.io',
