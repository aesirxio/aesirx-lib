...
import { SubTypeItemModel, SubTypeModel } from './Model';
import SubTypeRouter from './Route';
 ...
 * API Service
 */
class SubTypeApiService {
  route: any = null;

  constructor() {
    this.route = new SubTypeRouter();
  }
