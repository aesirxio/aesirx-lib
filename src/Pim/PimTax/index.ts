...
import { TaxItemModel, TaxModel } from './Model';
import TaxRouter from './Route';
...
class TaxApiService {
  ...
  getList = async (filter: any) => {
    try {
      ...
      const roleItems = new TaxModel(data);
