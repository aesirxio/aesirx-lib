...
import { FilteringFieldsetItemModel, FilteringFieldsetModel } from './Model';
import FilteringFieldsetRouter from './Route';
 ...
 * API Service
 */
class FilteringFieldsetApiService {
  route: any = null;

  constructor() {
    this.route = new FilteringFieldsetRouter();
  }
...
export { FilteringFieldsetApiService };
